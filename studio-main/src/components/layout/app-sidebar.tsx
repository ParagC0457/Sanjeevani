  ...
  return (
    ...
    >
      ...
      <div className="p-2 border-t">
          ...
          <div className="flex items-center gap-3">
            ...
            {!collapsed && (
              <div className="flex-1 overflow-hidden">
                <p className="truncate text-sm font-semibold text-secondary-foreground">Jane Doe</p>
        ...
        <Button variant="outline" className={cn('w-full mt-2', collapsed && 'justify-center')}>
